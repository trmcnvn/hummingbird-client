...
import layout from '../../../../../templates/components/app-feed/items/post/comment/actions';
...
export default class Actions extends Component {
  ...
  onCopy = () => {
    const message = this.intl.t('shared-addon.app-feed.items.post.actions.copied');
    this.notifications.success(message);
  };
  ...
  @action
  reportCreated() {
    const message = this.intl.t('shared-addon.app-feed.items.post.actions.reported');
    this.notifications.success(message);
  }
}
