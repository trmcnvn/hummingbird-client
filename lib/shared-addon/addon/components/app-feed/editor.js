...
export default class Editor extends Component {
  ...
  @computed('message', 'maxLength', 'embed', 'uploads.[]', 'fileQueyEmpty')
  get canPost() {
  ...
  uploadFile = function* (file) {
    ...
    try {
      ...
      const message = getErrorMessage(error) || this.intl.t('shared-addon.app-feed.editor.errors.failed-upload');
